...
class User(Base):
    ...
    role_id = Column(UUID(as_uuid=True), ForeignKey('roles.id'), nullable=True)  # Foreign key to Roles table
    ...
    articles = relationship("Articles", back_populates="author", cascade="all, delete-orphan")
